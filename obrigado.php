...
<html class="wide wow-animation" lang="pt-br">
  <head>
    ...
    <style>.ie-panel{display: none;background: #212121;padding: 10px 0;box-shadow: 3px 3px 5px 0 rgba(0,0,0,.3);clear: both;text-align:center;position: relative;z-index: 1;} html.ie-10 .ie-panel, html.lt-ie-10 .ie-panel {display: block;}.rd-navbar-nav .rd-nav-link {color: white !important;transition: color 0.3s ease;}.rd-navbar-nav .rd-nav-link:hover {color: #90ee90 !important; /}
</style>
  </head>
  <body>
    <div class="ie-panel">
                ...
                <div class="rd-navbar-main-element">
                  <div class="rd-navbar-nav-wrap">
                    <ul class="rd-navbar-nav">
                      <li class="rd-nav-item"><a class="rd-nav-link" href="index.php">Início</a></li>
                      ...
                      <li class="rd-nav-item active"><a class="rd-nav-link" href="contacts.html">Contatos</a></li>
                    </ul>
                  </div>
    ...
    <section class="section section-bredcrumbs" 
      style="background: url(images/breadcrumbs-1920x440.jpg) no-repeat center / cover">
...
<div class="container">
    ...
    <br>
    <h4><p>Seu pagamento foi processado com sucesso. Clique no botão abaixo para baixar seu arquivo.</p></h4>
</div>
  ...
  <div class="container">
    <div class="box-cta">
      <div class="box-cta-inner">
        <h3>Já pode baixar o seu álbum agora!</h3>
        <p>Seu pagamento foi processado com sucesso. Clique no botão abaixo para baixar seu arquivo.</p>
      </div>
      <!-- Botão de Download -->
      <a href="javascript:void(0);" id="downloadBtn" class="button-link">
        <center>
          <button class="button">
            ...
            <span class="label">Baixar Agora</span>
          </button>
        </center>
      </a>
    </div>
...
<!-- Script para gerar o token e redirecionar para o link mascarado -->
<script>
document.getElementById("downloadBtn").addEventListener("click", function() {
    fetch('https://reggaeroots.com.br/api/generate-temp-link.php', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ email: 'reggaeroots.com.br' }) // Pode substituir pelo email do usuário
    })
    .then(response => response.json())
    .then(data => {
        if (data.status === 'ok') {
            // Redireciona automaticamente para o link de download mascarado
            window.location.href = "https://reggaeroots.com.br/download.php?token=" + data.token;
        } else {
            alert('Houve um erro ao gerar o link de download. Tente novamente.');
        }
    })
    .catch(error => {
      ...
      <footer class="section footer-2">
        <div class="container">
          <div class="row row-40">
            <div class="col-md-6 col-lg-3"><a class="footer-logo" href="index.html"><img src="images/logo-302x44.png" alt="" width="180" height="26"/></a>
